...
* 📈 we started supporting :ref:`smart scheduling <considerations/footprint:Smart job scheduling>` to greener datacenters (``2026-03-12``)
...
* 📘 Added documentation on how to integrate :ref:`the platform LLM as coding assistant in VScode <reference/llm:Use it as a code assistant with VScode>` (``2025-02-13``)
...
* 📈 enable Gradio UI for inference on the :ref:`platform dedicated resources <nomad-gradio>` (``2024-11-26``)
